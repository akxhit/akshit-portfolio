...
export function Nav() {
  ...
  const [chapter, setChapter] = useState('Mobile 0→1');
  ...
  useEffect(() => {
    ...
    const read = () => {
      ...
      if (secs.length) {
        ...
        setChapter(cur ? cur.dataset.chapter : 'Mobile 0→1');
      }
    };
    const onScroll = () => {
    ...
    <div className="nav">
      <div className="wrap">
        ...
        <span className="nav-name">
          <b>PrepInsta Prime Mobile App</b>&nbsp;
        ...
        <span className="nav-date">Dec 2024 — Sep 2025</span>
      </div>
    </div>
  );
}
